...
async def test_tt_um_counter(dut):
    ...
    dut.ui_in.value = 0b00010101  # load=1, output_en=0, count_up=1, data=0b10101 → 0b00010101 = 16
    await ClockCycles(dut.clk, 1)
    ...
    dut.ui_in.value = 0b00000110  # load=0, output_en=1, count_up=1
    ...
    dut.ui_in.value = 0b00000010  # count_up = 0, output_en = 1
